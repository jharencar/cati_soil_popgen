...
patches <- data.frame(Patch = c("Westward Ridge", "Calamagrostis", "Taylor", "Fern Gulch", "San Quentin", "Petroglyph Rock"), lat = c(37.91461, 37.91573, 37.91200, 37.91083, 37.91308, 37.91100), long = c(-122.4958, -122.4978, -122.4879, -122.4857, -122.4900, -122.4941))
...
a <- ggplot() +
  ...
  geom_point(data = samps, aes(x = Long_dd, y = Lat_dd), color=) +
